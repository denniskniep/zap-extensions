...
/**
 * This class is copied from ZAP org.parosproxy.paros.network.HTTPSender
 * ToDo: Refactor it during a new ZAP release and integrate it in the core.
 */
public class HttpRedirectFollower {
    ...
    public static HttpRequestConfig getHttpRequestConfig() {
        HttpRequestConfig httpRequestConfig = HttpRequestConfig.builder().setRedirectionValidator(new HttpRedirectionValidator() {
            ...
            public boolean isValid(URI redirection) {
                //ToDo: (Question) How can I validate if the uri is in scope of the active scan?
                return true;
            }
