...
public class DateTimeRangeListInsideRangeTest {

    private List<DateTimeRangeList.DateTimeRangeWithValue<String>> testInsideRangeWithOneItem(LocalDateTime from, LocalDateTime till) {
        ...
        return store.getInsideRange(from, till);
    }
    ...
    public void testInsideRange_FromIsOutOfScope() {
        ...
        List<DateTimeRangeList.DateTimeRangeWithValue<String>> results = testInsideRangeWithOneItem(from, till);
